...
export default class Image3 extends React.Component {
    ...
    handleFileChange (data) {
        ...
        setTimeout(() => {
            this.props.setFile3({file: file, message: message});
        }, 500);
    }

    /*setDateURI (dataURI) {
        const image = dataURItoFile(dataURI, loadState() != undefined ? loadState().user.userName.toLowerCase().concat("3.png") : "image3.png");
        ...
        this.props.setFile3(this.state.file, this.state.error);
    }*/
