...
export default class Image2 extends React.Component {
    ...
    handleFileChange (data) {
        ...
        setTimeout(() => {
            this.props.setFile2({file: file, message: message});
        }, 500);

        /*const image = dataURItoFile(dataURI, loadState() != undefined ? loadState().user.userName.toLowerCase().concat("2.png") : "image2.png");
        ...
        this.props.setFile2(this.state.file, this.state.error);*/
    }
    render() {
        return (
            <div className="row">
