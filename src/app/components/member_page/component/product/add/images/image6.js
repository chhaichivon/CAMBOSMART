...
export default class Image6 extends React.Component {
    ...
    handleFileChange (data) {
        ...
        setTimeout(() => {
            this.props.setFile6({file: file, message: message});
        }, 500);
    }

    /*setDateURI (dataURI) {
        const image = dataURItoFile(dataURI, loadState() != undefined ? loadState().user.userName.toLowerCase().concat("6.png") : "image6.png");
        ...
        this.props.setFile6(this.state.file, this.state.error);
    }*/
