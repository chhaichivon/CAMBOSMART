...
export default class Image5 extends React.Component {
    ...
    handleFileChange (data) {
        ...
        setTimeout(() => {
            this.props.setFile5({file: file, message: message});
        }, 500);
    }

    /*setDateURI (dataURI) {
        const image = dataURItoFile(dataURI, loadState() != undefined ? loadState().user.userName.toLowerCase().concat("5.png") : "image5.png");
        ...
        this.props.setFile5(this.state.file, this.state.error);
    }*/
