...
let product4 = {
    ...
    image4: loadProduct() != undefined ? (loadProduct().productImage.length > 3 ? loadProduct().productImage[3] : 'example.png') : 'example.png'
};
    ...
    handleFileUpload(data){
        ...
        if(data.size == 1){
            ...
            setTimeout(() => {
                ...
                axios.post(API_ENDPOINT + 'member/products/' + product4.id + '/' + product4.image4, formData, AUTH_CONFIG(loadState() != undefined ? loadState().token : ''))
                    .then(function (res) {
                        let productState = loadProduct();
                        let index = productState.productImage.indexOf(product4.image4);
                        if (index !== -1) {
                            productState.productImage[index] = res.data.data.image;
                        }else {
                            productState.productImage.push(res.data.data.image)
                        }
                        product4.image4 = res.data.data.image;
        ...
        this.props.handleError4(message);
    }
                ...
                <div encType="multipart/form-data">
                    <div className="avatar-photo product">
                        ...
                        {this.state.img != "" ?
                            ...
                            :
                            product4.image4 != "example.png" ?
                                <img src={"/images/products/" + product4.image4} style={{height:"120px",width:"120px"}}/>
                                :
                                null
                        }
                    </div>
