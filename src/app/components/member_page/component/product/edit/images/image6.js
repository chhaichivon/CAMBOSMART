...
let product6 = {
    ...
    image6: loadProduct() != undefined ? (loadProduct().productImage.length > 5 ? loadProduct().productImage[5] : 'example.png') : 'example.png'
};
    ...
    handleFileUpload(data){
        ...
        if(data.size == 1){
            ...
            setTimeout(() => {
                ...
                axios.post(API_ENDPOINT + 'member/products/' + product6.id + '/' + product6.image6, formData, AUTH_CONFIG(loadState() != undefined ? loadState().token : ''))
                    .then(function (res) {
                        let productState = loadProduct();
                        let index = productState.productImage.indexOf(product6.image6);
                        if (index !== -1) {
                            productState.productImage[index] = res.data.data.image;
                        }else {
                            productState.productImage.push(res.data.data.image)
                        }
                        product6.image6 = res.data.data.image;
        ...
        this.props.handleError6(message);
    }
                ...
                <div encType="multipart/form-data">
                    <div className="avatar-photo product">
                        ...
                        {this.state.img != "" ?
                            ...
                            :
                            product6.image6 != "example.png" ?
                                <img src={"/images/products/" + product6.image6} style={{height:"120px",width:"120px"}}/>
                                :
                                null
                        }
                    </div>
