...
let product5 = {
    ...
    image5: loadProduct() != undefined ? (loadProduct().productImage.length > 4 ? loadProduct().productImage[4] : 'example.png') : 'example.png'
};
    ...
    handleFileUpload(data){
        ...
        if(data.size == 1){
            ...
            setTimeout(() => {
                ...
                axios.post(API_ENDPOINT + 'member/products/' + product5.id + '/' + product5.image5, formData, AUTH_CONFIG(loadState() != undefined ? loadState().token : ''))
                    .then(function (res) {
                        let productState = loadProduct();
                        let index = productState.productImage.indexOf(product5.image5);
                        if (index !== -1) {
                            productState.productImage[index] = res.data.data.image;
                        }else {
                            productState.productImage.push(res.data.data.image)
                        }
                        product5.image5 = res.data.data.image;
        ...
        this.props.handleError5(message);
    }
                ...
                <div encType="multipart/form-data">
                    <div className="avatar-photo product">
                        ...
                        {this.state.img != "" ?
                            ...
                            :
                            product5.image5 != "example.png" ?
                                <img src={"/images/products/" + product5.image5} style={{height:"120px",width:"120px"}}/>
                                :
                                null
                        }
                    </div>
