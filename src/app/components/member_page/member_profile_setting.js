...
let user={};
let image='';
class MemberProfileSetting extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            provinces: [
    ...
    componentWillReceiveProps(data) {
        if (data.result.code==200) {
            ...
            saveState(newUser);
            window.location.assign("/member/setting");
                    ...
                    <Row>
                        <Col xs={12} sm={12}>
                            ...
                            <ul style={{listStyleType:"none"}}>
                                ...
                                {loadState().user.city!=undefined&&loadState().user.city!=""?
                                <li>
                                    <span>Location:</span>
...
MemberProfileSetting = reduxForm
(
    {
...
function mapStateToProps(state){
    return{
        ...
        initialValues: {
            ...
            password:'',
            confirmPassword:'',
            location:loadState().user.city!=undefined&&loadState().user.city!=""?loadState().user.city:""
        }
    }
}
...
export default connect(mapStateToProps,mapDispatchToProps)(MemberProfileSetting)