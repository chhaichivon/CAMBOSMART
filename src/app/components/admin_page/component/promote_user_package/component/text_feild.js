...
export default class TextField extends React.Component {
    ...
    field() {
        const { input, componentClass, type, label, children, disabled } = this.props;
        return (
            <FormControl {...input} componentClass={componentClass} type={type} disabled={disabled} placeholder={label} autoComplete="on" >
                {children}
            </FormControl>
        );
    }
