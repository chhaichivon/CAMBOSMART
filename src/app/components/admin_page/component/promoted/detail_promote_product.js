...
class DetailPromoteProduct extends React.Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        ...
        return (
            <div >
                <br />
                <Link to="/admin/promote/list-promote-products"><i className="fa fa-angle-double-left" aria-hidden="true" style={{fontWeight:"bold"}}>&nbsp;Back</i></Link>
                <br/><br/>
                {product != undefined ?
                    <Row>
                        ...
                        <Col xs={12} sm={12} md={9} lg={9}>
                            <Panel header="Product Information">
                                <Table responsive>
                                    ...
                                    <tr>
                                        <td><b>Price</b></td>
                                        <td>{(product[0].store_product.price*product[0].store_product.discount)/100}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Discount From Date</b></td>
                                        <td>{DetailPromoteProduct.dateFormat(product[0].store_product.discountFromDate)}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Discount End Date</b></td>
                                        <td>{DetailPromoteProduct.dateFormat(product[0].store_product.discountEndDate)}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><b>Post Date</b></td>
                                        <td>{DetailPromoteProduct.dateFormat(product[0].store_product.createDate)}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Expired Date</b></td>
                                        <td>{DetailPromoteProduct.dateFormat(product[0].store_product.expireDate)}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Block Date</b></td>
                                        <td>{DetailPromoteProduct.dateFormat(product[0].store_product.blockDate)}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Status</b></td>
                                        <td>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailPromoteProduct);