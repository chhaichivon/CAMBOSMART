...
import { insertAdvertiserAction } from './../../../../../actions/admin/advertisement/advertiser';
import SweetAlert from 'sweetalert-react';
import '../../../../../../../node_modules/sweetalert/dist/sweetalert.css';

class AdvertisementInfo extends React.Component{
    constructor(props){
        super(props);
        this.state = {
             provinces: [
    ...
    formSubmit(value){
        if(this.state.file != undefined && this.state.file != null && this.state.file != ""){
            this.props.insertAdvertiserAction({
                token: loadState() != undefined ? loadState().token : '',
                advertiser: {
                    page: this.props.advertisement.page,
                    location: this.props.advertisement.location,
                    advertiser: {
                        name: value.name,
    ...
    componentWillReceiveProps(data) {
        if (data.advertiserInsert.code == 200) {
            this.handleUploadFile(data.advertiserInsert.id, this.state.file);
        } else if (data.advertiserInsert.code == 400 || data.advertiserInsert.code == 112) {
            this.setState({
                fail: true,
                message: data.advertiserInsert.message
            })
        }
    }
                    ...
                    <Row>
                        ...
                        <Col lg={6}>
                            <Row>
                                ...
                                <Col lg={8}>
                                     <Field name="discount" type="number" component={FormField} label="Discount" icon="fa fa-percent"/>
                                </Col>
                            </Row>
                            <Row>
                                <Col lg={4} style={{marginTop: '10px', textAlign: 'right'}}>
                                ...
                                <Col lg={8}>
                                    <Field name="page" values={this.props.advertisement.page} type="text" component={FormTextBox} label="Ads Page" icon="fa fa-arrows" disabled/>
                                </Col>
                            </Row>
                            <Row>
                                <Col lg={4} style={{marginTop: '10px', textAlign: 'right'}}>
                                ...
                                <Col lg={8}>
                                    <Field name="location" values={this.props.advertisement.location} type="text" component={FormTextBox} label="Ads location" icon="fa fa-location-arrow" disabled />
                                </Col>
                            </Row>
                            <Row>
                                <Col lg={4} style={{marginTop: '10px', textAlign: 'right'}}>
                            ...
                            <Row>
                                ...
                                <Col lg={8}>
                                    <FormGroup>
                                        <FormControl value={this.props.advertisement.description} componentClass="textarea" placeholder="Advertising description" style={{height: 150}} disabled/>
                                    </FormGroup>
                                </Col>
                            </Row>
                            <Row>
...
AdvertisementInfo = reduxForm({
    form: 'form_advertisement_info',
...
function mapStateToProps(state){
    return{
        advertiserInsert: state.advertiserInsert,
        initialValues: {
            name: '',
            description: '',
            email: '',
...
function mapDispatchToProps(dispatch) {
    return bindActionCreators({ insertAdvertiserAction }, dispatch)
}

export default connect(mapStateToProps, mapDispatchToProps) (AdvertisementInfo);