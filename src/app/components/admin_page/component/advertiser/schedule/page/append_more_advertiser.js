...
import AppendScheduleList from './append_schedule_list';
...
class AppendMoreAdvertiser extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            pages: [
            ...
            <div>
                ...
                <Panel className="advertisement" header={<strong>Advertisement Schedule</strong>}>
                    <Row>
                        ...
                        <Col md={4}>
                            <Field name="page" type="select" onChange={this.handlePage} component={FormSelectField} placeholder="Advertising page wanted?" values={this.state.pages} icon="fa fa-globe"/>
                        </Col>
                    </Row>
                    <Row>
                        <Col md={6}>
                        ...
                        <Col md={6} lg={6}>
                            { this.props.schedule.advertisements != undefined ?
                                <AppendScheduleList advertisement={{id: this.props.params.id, page: advertisement.page, location: advertisement.location}} advertisements={this.props.schedule.advertisements} />
                                :
                                null
                            }
                        </Col>
...
AppendMoreAdvertiser = reduxForm({
    form: 'form_append_more_advertiser',
...
export default connect(mapStateToProps, mapDispatchToProps)(AppendMoreAdvertiser);