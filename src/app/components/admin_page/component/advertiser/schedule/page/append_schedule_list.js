...
class AppendScheduleList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            value: '',
    ...
    formSubmit(value) {
        ...
        this.props.renewAdvertiserAction({
            ...
            advertiser: {
                ...
                advertise: {
                    id: {$oid: this.props.advertisement.id},
            ...
            this.props.advertisements == undefined ? null :
                <div>
                    <Row style={{width: '100%', marginLeft: '13px'}}>
                        ...
                        <Col lg={9}>
                            <Field name="location" type="text" component={FormTextBox} label="Advertisement location" icon="fa fa-location-arrow" values={this.props.advertisement.location} disabled/>
                        </Col>
                    </Row>
                    ...
                    <form onSubmit={handleSubmit(this.formSubmit)}>
                        ...
                        <Row style={{marginRight: '45px'}}>
                            <Col mdOffset={10} md={2} lg={12}>
                                <Button type="submit" disabled={submitting} style={{background: '#ff6903', color: 'white', fontWeight: 'normal', height: '40px', width: '99px'}}>
                                    SAVE
                                </Button>
                            </Col>
                        </Row>
...
AppendScheduleList = reduxForm({
    form: 'form_append_schedule_list',
...
export default connect(mapStateToProps, mapDispatchToProps)(AppendScheduleList);