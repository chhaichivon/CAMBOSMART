...
class AdvertiserPageList extends React.Component {
    constructor() {
        super();
        this.state = {
            startDate: null,
    ...
    handleSelect(eventKey) {
        ...
        this.props.fetchAdvertisersAction(advertiser);
        browserHistory.push(`/admin/advertisers/list/pages/${eventKey}`)
    }
                    ...
                    <div className="row">
                        ...
                        {total <= 10
                            ...
                            <Pagination style={{float: 'right'}}
                                        ...
                                        ellipsis
                                        boundaryLinks
                                        items={AdvertiserPageList.handleItem(total)}
                                        maxButtons={5}
...
AdvertiserPageList = reduxForm({
    form: 'form_advertiser_page_list',
...
export default connect(mapStateToProps, mapDispatchToProps)(AdvertiserPageList)
