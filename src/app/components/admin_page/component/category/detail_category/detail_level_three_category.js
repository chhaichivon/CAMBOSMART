...
class DetailLevelThreeCategory extends React.Component {
    constructor(props){
        super(props)
    }
    ...
    render(){
        ...
        return(
            <div>
                ...
                <Row>
                    <Col lgOffset={2} lg={8}>
                        <Link to="/admin/category/list-category/list-level-three">
                            <b>
                                <i className="fa fa-angle-double-left" aria-hidden="true">{' '}Back</i>
                            </b>
                        </Link>
                        <br/><br/>
                        <Panel className="advertisement-detail" header={<strong>Level Three Category Information</strong>} style={{textAlign: 'center'}}>
                            <Table responsive>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailLevelThreeCategory);
