...
class DetailLevelTwoCategory extends React.Component {
    constructor(props){
        super(props)
    }
            ...
            <div>
                ...
                <Row>
                    <Col lgOffset={2} lg={8}>
                        ...
                        <br/><br/>
                        <Panel className="advertisement-detail" header={<strong>Level Two Category Information</strong>} style={{textAlign: 'center'}}>
                            <Table responsive>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailLevelTwoCategory);
