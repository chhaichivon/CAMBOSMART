...
class EditLevelTwoCategory extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            status: false,
    ...
    componentWillReceiveProps(data){
        if(data.updateCategory.code == 200){
            location.href = '/admin/category/list-category/list-level-two';
        ...
        return (
            <div>
                ...
                <div style={{borderStyle: 'groove'}}>
                    <center><h4 style={{color: '#f77416'}}><b><u>Update Level Two Category</u></b></h4></center>
...
EditLevelTwoCategory = reduxForm({
    form: 'form_update_level_two_category',
...
export default connect(mapStateToProps, mapDispatchToProps)(EditLevelTwoCategory);